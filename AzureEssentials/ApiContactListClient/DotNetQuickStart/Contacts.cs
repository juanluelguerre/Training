...
{
    internal partial class Contacts : IServiceOperations<DotNetQuickStart>, IContacts
    {
        /// <summary>
        ...
        /// </param>
        internal Contacts(DotNetQuickStart client)
        {
            this._client = client;
        }
        
        private DotNetQuickStart _client;
        
        /// <summary>
        /// Gets a reference to the ContactListConsoleApp.DotNetQuickStart.
        /// </summary>
        public DotNetQuickStart Client
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<bool>> DeleteByIdWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<Contact>> PostByContactWithOperationResponseAsync(Contact contact, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (contact == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "PostByContactAsync", tracingParameters);
            }
